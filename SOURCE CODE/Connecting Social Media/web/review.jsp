<%-- 
    Document   : review
    Created on : Dec 13, 2016, 8:16:12 PM
    Author     : java4
--%>
    ...
    <div id="wrap" >
        ...
        <div id="left" >
            <div class="media user-media well-small">
                ...
                <%
                    ...
                    idd = (String) session.getAttribute("iddd");
                    ...
                    try {
                        ...
                        if (rs1.next()) {
                            ...
                            session.setAttribute("pronames", proname);
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <!---@1 part Start--->
                <form action="perch.jsp" method="get">
                <center>
                    
                    <br><br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">Please Give a Review</h2></center>
                    <img src="view4.jsp?id=<%=idd%>" width="220" height="200"/><br><br>
                    <textarea cols="30" rows="4"><%=conte%></textarea><br><br>
                    <textarea cols="30" rows="4" name="review" placeholder="Please Give a Reviews"></textarea><br><br>
                    <select class="inputss" required="" name="rating" >
