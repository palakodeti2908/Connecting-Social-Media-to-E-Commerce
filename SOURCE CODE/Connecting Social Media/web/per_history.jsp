<%-- 
    Document   : per_history
    Created on : Dec 13, 2016, 8:35:44 PM
    Author     : java4
--%>
...
%>
        ...
        <div id="content">
           ...
           <!---@1 part Start--->
           <center>
               <br><br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">Other User Perches History and Rating Reviews</h2></center>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            ...
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: black">Product Name</th>
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: black">User Name</th>
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: black">Rating</th>
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: black">Review</th>
                        </tr>
                        <tr>
                            <%
                               ...
                               String idd = request.getParameter("id");
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from pro_history where proid='"+idd+"'");
                                    while (rs.next()) {%>
                            <td style="font-size: 16px"><%=rs.getInt("id")%></td>   
                            <td style="font-size: 16px"><%=rs.getString("proname")%></td>  
                            <td style="font-size: 16px"><%=rs.getString("uname")%></td> 
                            <td style="font-size: 16px"><%=rs.getString("rating")%></td> 
                            <td style="font-size: 16px"><textarea rows="3" cols="30"><%=rs.getString("review")%></textarea></td> 
